describe("Movie popup", () => {
    ...
    it("Like movie when not logged in", () => {
        ...
        cy.get("button[aria-label='add to favorites']").not(".MuiIconButton-colorSecondary");
    ...
    it("Like/unlike movie when logged in", () => {
        ...
        cy.get("#likesCount").then(($likes1) => {
            ...
            cy.get("button[aria-label='add to favorites']").click();
            cy.get("button[aria-label='add to favorites']").should("have.class", "MuiIconButton-colorSecondary");
        ...
        cy.get("#likesCount").then(($likes1) => {
            ...
            cy.get("button[aria-label='add to favorites']").click();
            cy.get("button[aria-label='add to favorites']").should("not.have.class", "MuiIconButton-colorSecondary");
